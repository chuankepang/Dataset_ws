...
bool move_forward(float shoulder_pan_joint, float shoulder_lift_joint, float elbow_joint, float wrist_1_joint, float wrist_2_joint, float wrist_3_joint)
{
    moveit::planning_interface::MoveGroupInterface group("manipulator");
    double targetPose[6] = {shoulder_pan_joint, shoulder_lift_joint, elbow_joint, wrist_1_joint, wrist_2_joint, wrist_3_joint};
...
bool move(float x, float y, float z, float roll, float pitch, float yaw)
{
    ...
    geometry_msgs::Pose target_pose; //设置发送的数据，对应于moveit中的拖拽，设置数据类型
    tf::Quaternion Q;
    //欧拉角转四元数
...
void go_home(void)
{
    ...
    current_state.setToDefaultValues(current_state.getJointModelGroup("manipulator"), "origin");
